...
import { deleteCourse, findByCreateBy, getCourseByCondition } from '../../service/CourseService.ts';
import { confirmDelete } from '../../utils/swalUtils.ts';

const ListCourseTeacher = () => {
  ...
  function getAllCourse(){
    findByCreateBy(currentPage, itemsPerPage).then((response:any) =>{
  ...
  return (
    <>
      <Breadcrumb pageName="Danh sách khóa học của tôi" />
