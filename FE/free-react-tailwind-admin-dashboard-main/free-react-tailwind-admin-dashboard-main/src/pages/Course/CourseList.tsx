...
const CourseList = () => {
  ...
  function dataSearch(){
    getCourseByCondition(0,0,param).then((response:any) =>{
      console.log('data search',response.content)
    })
  }
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap items-center gap-4 mb-6 p-4 bg-white rounded-xl shadow-md">
        ...
        <button className="flex items-center justify-center gap-2 bg-gray-500 text-white py-3 px-6 rounded-lg shadow-lg hover:bg-gray-700 transition-all text-lg font-semibold">
          <RefreshCcw size={20} />
          Làm mới
        </button>
        <div className="relative flex-1 min-w-[350px]">
